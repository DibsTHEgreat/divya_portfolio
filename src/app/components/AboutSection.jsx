      ...
      <div className="w-full md:w-1/2 mb-6 md:mb-0">
        ...
        <div className="md:w-1/2 md:pl-10">
          ...
          <p className="text-black text-base md:text-lg mb-6 pb-3">
            I am an avid learner of Computer Science, deeply passionate about crafting meaningful 
            projects that serve a real purpose and will leave an impact on the world. My approach 
            to learning is all about hands-on experience; I believe in jumping right into 
            projects to grasp complex ideas. This approach, I believe, is the key to not only 
